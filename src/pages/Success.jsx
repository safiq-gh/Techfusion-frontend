...
export default function Success() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-24 relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-void-black -z-10" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-cyber-blue/10 rounded-full blur-[200px]" />
      ...
      >
        <div className="poster-box p-10 text-center">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            ...
            <div className="space-y-3 mb-8">
              {steps.map(({ icon: Icon, title, desc }, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-4 p-4 poster-box !bg-white/1 border-white/5 text-left"
                >
                  ...
                  <div>
                    <p className="font-heading font-bold text-white text-sm tracking-wide">{title}</p>
